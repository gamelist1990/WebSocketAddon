...
// Import the actual DuelManager and its interfaces, renaming the class to avoid conflict
// Assuming the path "../utils/duel" is correct relative to this command file
import { DuelManager as ActualDuelManager, DuelConfig, DuelRequest, RegisteredKit } from "../utils/duel";
